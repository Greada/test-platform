...
一站式测试管理平台，支持测试用例管理、HTTP 执行、JSON 匹配、测试套件、执行报告、JSON Diff 分析、错误模式聚合、分类管理、AI 智能生成预期结果、OpenAPI 批量导入、JWT 权限管理。
...
Java 17 / Spring Boot 3.3.6 / MyBatis-Plus 3.5.9 / MySQL 5.7+ / Vue 3 + Element Plus / Docker
...
| [docs/API.md](docs/API.md) | API 接口文档（V1 ~ V3.2） |
