...
> **[DEPRECATED] 本文件已废弃（2026-08-28）**——与仓库根 README.md 双份维护已漂移。
> 请阅读并更新根目录 [`README.md`](../README.md)（技术栈/部署/安全特性已同步至当前）。
> 登记见 [`DEPRECATED.md`](../DEPRECATED.md)。
> 以下内容为 2026-08-05 的历史快照，仅存档。

一站式测试管理平台，支持测试用例管理、HTTP 执行、JSON 匹配、测试套件、执行报告、JSON Diff 分析、错误模式聚合、分类管理、AI 智能生成预期结果、OpenAPI 批量导入、JWT 权限管理、CI/CD 自动化部署。前端经过代码质量审查，修复了 errorHandler 注册、loading 状态管理、401 跳转、API 并行化、路由懒加载、死代码清理、composable 抽取等 17 项问题。
