...
description: Anti-slop frontend skill for landing pages, portfolios, and redesigns. Reads the brief, infers design direction, sets VARIANCE/MOTION/DENSITY dials, maps to real design systems (Fluent, Carbon, shadcn, Radix), enforces typography/color/spacing/layout/motion discipline, canonical GSAP skeletons, strict pre-flight check. Ships interfaces that don't look templated.
license: MIT
compatibility: opencode
metadata:
  source: "Adapted from taste-skill by Leonxlnx (MIT) — https://github.com/Leonxlnx/taste-skill"
  requires_codegraph: false
---

> **Tool mapping (OpenCode):** This skill uses:
> - `bash` for install commands (npx, npm)
