...
description: Awwwards-tier UI design skill. Double-bezel nested card architecture, fluid island nav with staggered mask reveal, magnetic button hover physics, scroll interpolation spring motion, custom cubic-bezier transitions. Generates $150k+ agency-level React/Tailwind interfaces.
license: MIT
